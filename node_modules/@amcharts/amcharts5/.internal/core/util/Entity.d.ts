...
export declare class Adapters<E extends Settings> {
     ...
     * @see {@link https://www.amcharts.com/docs/v5/concepts/settings/adapters/} for more info
     */
    add<Key extends keyof E["_settings"]>(key: Key, callback: <O extends E["_settings"]>(value: O[Key], target?: O, key?: Key) => O[Key]): IDisposer;
    /**
     * @ignore
     */
 ...
 */
export declare abstract class Settings implements IDisposer, IAnimation {
    /**
     * Unique ID.
     */
    uid: number;
    ...
    protected _animatingCount: number;
    private _disposed;
